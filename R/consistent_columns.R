# spreadsheets with differing column values
library(broman)
library(here)
...
pdf(here("Figs/spreadsheet_colnames1.pdf"), height=5, width=8.5)
excel_fig(mat1, col_names=TRUE)
dev.off()

pdf(here("Figs/spreadsheet_colnames2.pdf"), height=5, width=8.5)
excel_fig(mat2, col_names=TRUE)
dev.off()


pdf(here("Figs/spreadsheet_colnames3.pdf"), height=5, width=8.5)
