...
# bad example 2
pdf(here("Figs/not_rectangle_2.pdf"), height=5, width=10, pointsize=12)
...
# that one filled in
pdf(here("Figs/not_rectangle_2_corr1.pdf"), height=5, width=10, pointsize=12)
mat5[1,1] <- "id"
for(i in 1:3) {
    mat5[3:7, i] <- mat5[2,i]
...
# split into two
pdf(here("Figs/not_rectangle_2_corr2a.pdf"), height=3, width=3.5, pointsize=12)
#### weights
...
#### gtt
pdf(here("Figs/not_rectangle_2_corr2b.pdf"), height=5, width=5, pointsize=12)
mat5gtt <- mat5[,c(1, 4:6)]
mat5gtt[1,2] <- "GTT time"
excel_fig(mat5gtt, col_names=FALSE, cellwidth=c(85, 85, 85, 110, 110))
dev.off()

pdf(here("Figs/not_rectangle_2_corr3b.pdf"), height=5, width=6.7, pointsize=12)
# and fix those notes
...
# bad example 4
pdf(here("Figs/not_rectangle_4.pdf"), height=5, width=10, pointsize=14)
mat4 <- rbind(rep("", 7),
