...
\begin{frame}[c]{No empty cells}
  ...
  % particularly the case of date then gap then another date
...
\begin{frame}[c]{Make it a rectangle}
  ...
  % show various non-rectangular things
  % subjects as rows, variables as columns; one header row
...
\only<1>{
\hspace{0.1\textwidth}
  \includegraphics[height=0.7\textheight]{Figs/no_highlighting.pdf} }

\only<2|handout 0>{
\hspace{0.1\textwidth}
\includegraphics[height=0.7\textheight]{Figs/no_highlighting_2.pdf}}
